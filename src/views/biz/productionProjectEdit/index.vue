...
<script>
import { listAll } from '@/api/biz/productionProject'
import { getFlowInfoByFlowId } from '@/api/flowable/definition'
import { formatDate } from '@/utils'
import ProductionProjectEditForm from '@/views/biz/productionProjectEdit/form/index'

export default {
  name: 'Index',
  components: { ProductionProjectEditForm },
  data() {
    return {
      dataid: '',
