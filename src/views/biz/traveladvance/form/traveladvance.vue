  ...
  <div>
    ...
    >
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="24">
          <el-form-item label="借款原因" prop="yuanyin">
            <el-input
                v-model="form.variables.yuanyin"
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        ...
        <el-col :span="12">
          <el-form-item label="借款单位" prop="jkdanwei">
            <el-select v-model="form.variables.jkdanwei" :disabled="!isformdisabled" placeholder="请选择借款单位"
                       style="width:100%;"
            >
              <el-option
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="用途类型" prop="type">
            <el-select v-model="form.variables.type" :disabled="!isformdisabled" placeholder="请选择用途类型"
                       style="width:100%;"
                       @change="clearNum"
            >
              <el-option
        ...
        <el-col :span="12">
          <el-form-item v-if="isShowNumDiv" :label="fixNumLabel+'编号'" prop="numbers">
            <el-input
            ...
            >
              <el-button
                  ...
                  @click="isformdisabled && showSelectLoanBox(form.variables.type)"
              ></el-button>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row v-if="isShowNumDiv && isShowNameAndJSF" :gutter="4" style="padding:0 10px;">
        <el-col :span="24">
          <el-form-item label="出差事由" prop="remake">
            <el-input
                v-model="form.variables.remake"
                disabled
                style="width:100%;"
            />
          </el-form-item>
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="付款方式" prop="fukuanfanghsi">
            <el-select v-model="form.variables.fukuanfanghsi" :disabled="!isformdisabled" placeholder="请选择付款方式"
                       style="width:100%;"
            >
              <el-option
        ...
        <el-col :span="12">
          <el-form-item label="人事借款编号" prop="nums">
            <el-input
...
<script>
import { addTraveladvance, updateTraveladvance } from '@/api/biz/traveladvance'
...
export default {
  ...
  methods: {
    ...
    getTrackProject(row) {
      ...
      const result =
          row &&
          keymap.get(this.form.variables.type) &&
          keymap.get(this.form.variables.type)()
      this.form.variables = {
        ...this.form.variables,
        ...result
      ...
      this.$refs['form'].validate(async(valid) => {
        if (valid) {
          ...
          if (procInsId != '' && typeof (procInsId) != 'undefined' && procInsId != 'undefined') {
            ...
            const updateSealmsg = await updateTraveladvance({
              id: this.form.id,
              ...this.form.variables
            })
            ...
            const { code, data } = await addTraveladvance(this.form.variables)
            if (code == 200) {
              this.form.id = data
  ...
  computed: {
    isShowNumDiv: function() {
      return ['1', '2'].indexOf(this.form.variables.type) !== -1
    },
    isShowNameAndJSF() {
      return ['1'].indexOf(this.form.variables.type) !== -1
    },
    fixNumLabel() {
      return this.typeOptions.filter(
          (item) => item.dictValue === this.form.variables.type
      )[0].dictLabel
    }
  }
}
