...
<template>
  <div>
    ...
    >
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="营销报销编号" prop="yxnums">
            <el-input v-model="form.variables.yxnums" disabled placeholder="自动生成" style="width:100%;"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="报销类型" prop="leixing">
            <el-select v-model="form.variables.leixing" :disabled="!isformdisabled" placeholder="请选择报销类型"
                       style="width:100%;"
                       @change="clearNum"
            >
              <el-option
      ...
      <el-row v-if="isShowNumDiv" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="跟踪立项编号" prop="yxnum">
            <el-input
                v-model="form.variables.yxnum"
                disabled
                placeholder="点击选择跟踪立项编号"
                style="width:100%;"
            >
              <el-button
                  slot="append"
                  icon="el-icon-third-guide"
                  @click="isformdisabled && showSelectLoanBoxs(form.variables.leixing)"
              ></el-button>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="项目名称" prop="yxname">
            <el-input
                v-model="form.variables.yxname"
                disabled
                style="width:100%;"
            />
          </el-form-item>
      ...
      <el-row v-if="isShowNumDiv" :gutter="4" style="padding:0 10px;">
        ...
        <el-col :span="12">
          <el-form-item label="历史报销金额(元)" prop="zbaoxiao">
            <el-input
                v-model="form.variables.zbaoxiao"
                disabled
      ...
      <el-row v-if="isShowNumDiv" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="项目推进申请编号" prop="gongguannum">
            <el-input
                v-model="form.variables.gongguannum"
                disabled
                placeholder="点击选择项目推进申请编号"
                style="width:100%;"
            >
              <el-button
                  slot="append"
                  icon="el-icon-third-guide"
                  @click="isformdisabled && ( isChoose = 'ProjectPromotionPopup')"
              ></el-button>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="项目名称" prop="gongguanname">
            <el-input
                v-model="form.variables.gongguanname"
                disabled
                placeholder="请输入项目名称"
                style="width:100%;"
            />
      ...
      <el-row v-if="isShowNumDiv" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="项目推进预算" prop="gongguanyusuan">
            <el-input
                v-model="form.variables.gongguanyusuan"
                disabled
      ...
      <el-row v-if="isShowNumDiv" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="推进预算上限" prop="zongyusuan">
            <el-input
                v-model="form.variables.zongyusuan"
                disabled
                placeholder="请输入推进预算上限"
                style="width:100%;"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row v-if="isShowNumDiv" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="剩余推进额度" prop="bencijine">
            <el-input
                v-model="form.variables.bencijine"
                disabled
                placeholder="请输入剩余推进额度"
                style="width:100%;"
            />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-if="isShowNameAndJSF" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="投标立项编号" prop="toubiaonum">
            <el-input
                v-model="form.variables.toubiaonum"
                disabled
        ...
        <el-col :span="12">
          <el-form-item label="项目名称" prop="toubiaoname">
            <el-input
                v-model="form.variables.toubiaoname"
                disabled
                placeholder="请输入项目名称"
                style="width:100%;"
            />
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="报支单位" prop="baoxiaodanwei">
            <el-select
                v-model="form.variables.baoxiaodanwei"
                :disabled="!isformdisabled"
                placeholder="请选择报支单位"
                style="width:100%;"
            >
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="报销金额大写" prop="daxiejine">
            <el-input
      ...
      <el-row v-if="form.variables.sfdx == 'Y'" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="借款金额(元)" prop="jiejine">
            <el-input
                v-model="form.variables.jiejine"
                disabled
        ...
        <el-col :span="12">
          <el-form-item label="待抵消金额(元)" prop="daidixiaojine">
            <el-input
                v-model="form.variables.daidixiaojine"
                disabled
                placeholder="请输入待抵消金额(元)"
                style="width:100%;"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row v-if="form.variables.sfdx == 'Y'" :gutter="4" style="padding:0 10px;">
        <el-col :span="12">
          <el-form-item label="本次冲销金额(元)" prop="dixiaojine">
            <el-input-number
                v-model="form.variables.dixiaojine"
                :disabled="!isformdisabled"
                :min="0"
                :precision="2"
                :step="1"
      ...
      <!--      <el-row :gutter="4" style="padding:0 10px;">-->
      <!--        <el-col :span="12">-->
      <!--          <el-form-item label="差旅报销编号" prop="clbxnums">-->
      <!--            <el-input-->
      <!--              v-model="form.variables.clbxnums"-->
      <!--              disabled-->
      <!--              placeholder="自动生成差旅报销编号"-->
      <!--              style="width:100%;"-->
      <!--            ></el-input>-->
      <!--          </el-form-item>-->
      <!--        </el-col>-->
      ...
      <el-row :gutter="4" style="padding:0 10px;">
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column label="发票编号" prop="num">
              <template slot-scope="scope">
                <el-input
            ...
            <el-table-column label="发票号码" prop="nums">
              <template slot-scope="scope">
                <el-input
            ...
            <el-table-column label="发票开具时间" prop="time">
              <template slot-scope="scope">
                <el-date-picker
    ...
    <!--    />-->
    <!--    <TrainProjectPopup v-if="isChoose === 'TrainProjectPopup'" @choosedProect="getTrackProject"/>-->
    <TrackProjectPopup v-if="isChoose === 'TrackProjectPopup'" req-url="/system/trackproject/list"
    ...
    <BidProjectPopup v-if="isChoose === 'BidProjectPopup'" req-url="/system/bidproject/listForCreator"
                     @choosedProect="getTrackProject"
    />
    <ProjectPromotionPopup v-if="isChoose === 'ProjectPromotionPopup'" req-url="/system/projectpromotion/list"
...
<script>
import { addYxbaoxiao, getYxbaoxiao, updateYxbaoxiao } from '@/api/biz/yxbaoxiao'
...
import ProjectPromotionPopup from '@/components/Popup/ProjectPromotionPopup'
// 通过跟踪立项编号获取已使用推进成本
...
export default {
  ...
  data() {
    return {
      ...
      fujiandata: {
        fieldName: 'fujian',
        tableName: 'pms_yxbaoxiao'
      },
      // 行政办公报销清单表格数据
      pmsFapiaoxiangqingList: [],
      // 部门树选项
      deptOptions: '',
      fileList: [],
      bumennameOptions: [],
      ...
      rules: {
        ...
        yxnum: [
          { required: true, message: '点击选择跟踪立项编号', trigger: 'blur' }
        ],
        yxname: [
          { required: true, message: '请输入项目名称', trigger: 'blur' }
        ],
        xtfsx: [
          { required: true, message: '请输入协调费上限', trigger: 'blur' }
        ],
        zbaoxiao: [
          { required: true, message: '请输入历史报销金额(元)', trigger: 'blur' }
        ],
        gongguannum: [
          { required: true, message: '点击选择项目推进申请编号', trigger: 'blur' }
        ],
        gongguanname: [
          { required: true, message: '请输入项目名称', trigger: 'blur' }
        ],
        gongguanyusuan: [{ required: true, message: '请输入项目推进预算', trigger: 'blur' }],
        toubiaonum: [{ required: true, message: '点击选择投标立项编号', trigger: 'blur' }],
        toubiaoname: [{ required: true, message: '请输入项目名称', trigger: 'blur' }],
        baoxiaodanwei: [{ required: true, message: '请选择报支单位', trigger: 'change' }],
        baoxiaojine: [{ required: true, message: '请输入报销金额(元)', trigger: 'change' }],
        daxiejine: [{ required: true, message: '请输入报销金额(元)大写', trigger: 'blur' }],
        sfdx: [{ required: true, message: '请选择是否抵消借款金额(元)', trigger: 'change' }],
        jiejine: [{ required: true, message: '点击选择借款信息', trigger: 'blur' }],
        daidixiaojine: [{ required: true, message: '请输入待抵消金额(元)', trigger: 'blur' }],
        dixiaojine: [{ required: true, message: '请输入本次冲销金额(元)', trigger: 'change' }],
  ...
  computed: {
    totalnum: function() {
      let num = 0.0
      this.form.variables.pmsFapiaoxiangqingList.forEach((item) => {
        num += item.jine * 1
      })
    ...
    isShowNumDiv: function() {
      return ['1'].indexOf(this.form.variables.leixing) !== -1
    },
    isShowNameAndJSF() {
      return ['2', '3', '4'].indexOf(this.form.variables.leixing) !== -1
    },
    fixNumLabel() {
  ...
  created() {
    ...
    this.getDicts('mr_Invoice_type').then((response) => {
  ...
  methods: {
    ...
    offsetjineChange(data) {
      if (data > (this.form.variables.daidixiaojine * 1)) {
        this.form.variables.dixiaojine = ''
    ...
    getProjectPromotion(row) {
      if (row) {
        this.form.variables.gongguannum = row.bianhao
        this.form.variables.gongguanname = row.xiangmuname
        this.form.variables.gongguanyusuan = row.jine
        this.form.variables.jiushuibiaozhun = row.jiushuibiaozhun
        ...
        this.form.variables.zbaoxiaojine = row.zbaoxiaojine
        this.form.variables.bencijine = row.bencijine
      }
      this.isChoose = ''
    },
    ...
    choosedProect(row) {
      ...
      this.form.variables.jiejine = row.jiekuanjine
    ...
    handleAddPmsXzbaoxiaoqingdan() {
      ...
      this.form.variables.pmsFapiaoxiangqingList.push(obj)
    },
    /** 行政办公报销清单删除按钮操作 */
    handleDeletePmsXzbaoxiaoqingdan() {
      if (this.checkedPmsXzbaoxiaoqingdan.length == 0) {
        ...
        this.checkedPmsXzbaoxiaoqingdan.forEach((item) => {
          this.form.variables.pmsFapiaoxiangqingList.splice(item.index, 1)
        })
        if (this.form.variables.pmsFapiaoxiangqingList.length == 0) {
    ...
    checkMoney(){
      console.log(this.form.variables.heji,this.form.variables.baoxiaojine,this.form.variables.pmsFapiaoxiangqingList)
    ...
    onSubmit() {
      this.$refs['form'].validate(async(valid) => {
        if (valid && this.checkMoney()) {
          ...
          let submitFlag = true
          if(this.isShowNumDiv){
            let baoxiaojine = this.form.variables.baoxiaojine
            let promotionMoney = this.form.variables.qitafeiyong
            if(parseFloat(baoxiaojine) > (parseFloat(promotionMoney) * 1.2)){
              submitFlag = false
          ...
          if(submitFlag){
            if (procInsId != '' && typeof (procInsId) != 'undefined' && procInsId != 'undefined') {
              ...
              const updateSealmsg = await updateYxbaoxiao({
                id: this.form.id,
                ...this.form.variables
              })
              ...
              const { code, data } = await addYxbaoxiao(this.form.variables)
              if (code == 200) {
                this.form.id = data
    ...
    proData: {
      async handler(val) {
        if (val) {
          ...
          const { data } = await getYxbaoxiao(dataArr[0].id)
          console.log('getYxbaoxiao', data)
          this.form.variables = {
            ...data
          }
          // 请求附件详情
