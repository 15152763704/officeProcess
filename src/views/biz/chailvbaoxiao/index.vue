<template>
  <div class="app-container">
          ...
          <div v-show="ifCardShow">
            ...
            <div class="my-col">
              <el-form-item label="是否抵消借款" prop="counteract">
                <el-select
                  v-model="queryParams.counteract"
                  clearable
    ...
    >
      ...
      <el-table-column align="center" label="报销事由" prop="bxshiyou" sortable/>
      <el-table-column align="center" label="报销金额(元)" prop="bxjinexx" sortable/>
      <el-table-column
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="报销金额大写(元)" prop="bxjinedx">
          <el-input v-model="form.bxjinedx" placeholder="请输入报销金额大写(元)"/>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listChailvbaoxiao(this.queryParams).then((response) => {
    ...
    sfdxFormat(row, column) {
      return this.selectDictLabel(this.sfdxOptions, row.counteract)
    },
    // 报支单位字典翻译
    ...
    handleUpdate(row) {
      ...
      getChailvbaoxiao(id).then((response) => {
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          if (this.form.id != null) {
            updateChailvbaoxiao(this.form).then((response) => {
              this.msgSuccess('修改成功')
              this.open = false
              this.getList()
            })
          } else {
            addChailvbaoxiao(this.form).then((response) => {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有费用报销数据项?', '警告', {
        ...
        .then(function() {
          return exportChailvbaoxiao(queryParams)
        })
        .then((response) => {
