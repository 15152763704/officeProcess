<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="建设（投资）方" prop="touzifang" sortable/>
      <el-table-column align="center" label="投资规模" prop="touziguimo" sortable/>
...
<script>
import { list,delProjectpromotion,exportProjectPromotion} from '@/api/biz/projectPromotion'
...
export default {
  ...
  data() {
    return {
      formPath: '/task/record/index/projectPromotion',
      flowId: 'process_3n87ogho',
      ifCardShow: false,
      showTime: '',
      flowtitle: '',
      flowopen: false,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm(
        ...
        return delProjectpromotion(ids)
      }).then(() => {
        this.getList()
