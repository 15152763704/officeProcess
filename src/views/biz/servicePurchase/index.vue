<template>
  <div class="app-container">
      ...
      <el-card class="box-card" :body-style="{ padding: '14px 15px 7px' }">
        ...
        <el-collapse-transition>
          <div v-show="ifCardShow">
            <div class="my-col">
              <el-form-item label="采购编号" prop="num">
                <el-input
    ...
    >
      ...
      <el-table-column align="center" label="采购编号" prop="num" sortable/>
...
<script>
import { list,del } from '@/api/biz/servicePurchase'
...
export default {
  ...
  data() {
    return {
      formPath: '/task/record/index/servicePurchase',
      flowId: 'process_1lacylb7',
      ifCardShow: false,
      showTime: '',
      flowtitle: '',
      flowopen: false,
