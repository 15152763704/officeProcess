<template>
  <div class="app-container">
      ...
      <el-card class="box-card" :body-style="{ padding: '14px 15px 7px' }">
        ...
        <el-collapse-transition>
          <div v-show="ifCardShow">
            ...
            <div class="my-col">
              <el-form-item label="投标负责人" prop="fuzeren">
                <el-input
    ...
    >
      ...
      <el-table-column align="center" label="标底预算(元)" prop="xiangmubiaodi" sortable/>
...
<script>
import { list, exportData,delBidproject } from '@/api/biz/bidProject'
...
export default {
  ...
  data() {
    return {
      formPath: '/task/record/index/bidProject',
      flowId: 'process_jzqosrao',
      ifCardShow: false,
      showTime: '',
      flowtitle: '',
      flowopen: false,
