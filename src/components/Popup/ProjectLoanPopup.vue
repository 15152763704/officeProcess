<template>
  <el-dialog :before-close="onBeforeClose" :visible.sync="isshow" title="借款选择">
    <el-form ref="queryForm" :inline="true" :model="queryParams" label-width="120px">
      ...
      <div class="my-col">
        <el-form-item label="借款金额" prop="jiekuanjine">
          <el-input
    ...
    <el-table v-loading="loading" :data="projectList" class="table">
      <el-table-column align="center" label="借款事由" prop="ly"/>
      <el-table-column align="center" label="借款金额" prop="jiekuanjine"/>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      this.queryParams.jiekuanjine <= 0 ? (this.queryParams.jiekuanjine = null) : null
