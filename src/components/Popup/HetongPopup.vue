...
<template>
  <div class="zhezhou">
    <div class="mydialog">
      <div style="text-align: left;margin-top: 20px;margin-left: 30px;font-weight: 700;">项目选择</div>
      ...
      >
        ...
        <el-form-item label="合同金额" prop="hetongmoney">
          <el-input style="width: 200px;"
                    v-model="queryParams.hetongmoney"
                    placeholder="请输入项目金额"
                    clearable
                    size="small"
                    @keyup.enter.native="handleQuery"
      ...
      <el-table v-loading="loading" :data="projectList" class="table">
        ...
        <el-table-column align="center" label="合同金额(元)" prop="hetongmoney"/>
